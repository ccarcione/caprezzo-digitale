        ...
        Toastnotify.create = (options)=> {
            ...
            if (typeof options.callbackCancel === "function") {
                ...
                if (options.buttonCancel) {
                    ...
                    buttonCancel.innerHTML = "No, grazie";
                }
            ...
            if (typeof options.callbackIgnore === "function") {
                const buttonIgnore = document.createElement("span");
                if (options.buttonIgnore) {
                    buttonIgnore.innerHTML = options.buttonIgnore;
                } else {
                    buttonIgnore.innerHTML = "Non ora";
                }
                buttonIgnore.className = "a8k";
                buttoncontainer.appendChild(buttonIgnore);

                buttonIgnore.addEventListener("click", (event)=> {
                    event.stopPropagation();
                    options.callbackIgnore.call(removeToastnotify());
                });
            }
